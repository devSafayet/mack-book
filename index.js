...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.tlyoy.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const mackbookCollection = client.db('mackbook').collection('mackbooks')
